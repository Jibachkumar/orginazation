    ...
    <div className="max-w-6xl h-[455px] overflow-y-auto overflow-x-auto mx-auto px-3 py-6">
      <div className="border border-slate-100 w-md md:w-xl lg:w-5xl mx-auto rounded-md overflow-hidden">
        <div className="border-b bg-slate-50 border-slate-300 px-4 py-2 sm:flex-row sm:items-center sm:justify-between">
          <h2 className="font-medium text-sm text-center sm:text-md">
            Ministry of Labour and Industrial Relations
          </h2>
          <div className="md:flex lg:gap-[440px] mb-2 mt-2">
            <p className="font-medium">
              Permit Number: WP NO: MOL-WP-2026-24616
            </p>
        ...
        <div className="px-2 mt-2 pb-6">
          <div className="flex gap-x-6">
            ...
            <div className=" md:text-left font-serif grid gap-y-2 text-sm">
              <div className="flex flex-col justify-center">
                <div>
                  <span className="font-semibold">Surname:</span> YADAV
                </div>
                <div>
                  <span className="font-semibold">First Name:</span> Dipesh
                </div>
                <div>
          ...
          <div className="mt-2 font-serif">
            <div className="font-medium text-sm">
              <span className="font-semibold">Name of Employer:</span> Joyessur
              Agricultural Company Ltd
            </div>
            <div className="font-medium text-sm">
              <span className="font-semibold">Post Held:</span> Sugar Cane Field
              Labourers
            </div>
          </div>
          <div className="flex md:gap-3 mt-2">
            ...
            <div className="text-sm font-serif">
              <div>
                <span className="font-semibold">Date of Birth:</span> 20/08/2001
              </div>
              <div>
                <span className="font-semibold">Validity:</span> From 14/01/2026{" "}
                <span className="font-semibold">To</span> 13/01/2036
              </div>
            </div>
          </div>
        </div>
